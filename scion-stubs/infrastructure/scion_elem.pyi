...
class SCIONElement(object):
    ...
    def __init__(self, server_id: str, conf_dir: str, host_addr: HostAddrBase=None, port: int=None) -> None:
        ...
        self._core_ases = defaultdict(1, [object()])  # type: defaultdict[int, List[object]] # Mapping ISD_ID->list of core ASes
        self.init_core_ases()
    ...
    def _setup_sockets(self, init: bool = True) -> None:
        """
    ...
    #
    # def _get_handler(self, pkt: SCIONL4Packet):
    ...
    def _scmp_bad_path_metadata(self, pkt: SCIONExtPacket, e: SCMPError) -> SCIONExtPacket:
        """
    ...
    #         return False
    #     return self.send(pkt, None, None, None)
    ...
    def dns_query_topo(self, qname: str):
        return []
